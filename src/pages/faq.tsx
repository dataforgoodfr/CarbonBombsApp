...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: <div>Carbon bombs are the 425 largest fossil fuel projects but represent only around 45% of oil and gas extraction projects and 25% for coal of the total emissions likely to be generated by the entire fossil fuel extraction sector. These few projects each represent a high level of emission, which makes them a priority to tackle: defusing a single bomb means stopping the equivalent of hundreds of more fragmented projects. (Source <a className="text-blue-500" href="https://www.sciencedirect.com/science/article/pii/S0301421522001756">Kühne, 2022</a>)</div>
  },
  {
